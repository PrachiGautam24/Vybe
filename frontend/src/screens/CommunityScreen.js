...
export default function CommunityScreen({ navigation, route }) {
  ...
  const nearbyEvents = [
    ...
    },
    {
      id: 3,
      icon: '🚴',
      title: 'Cycling Tour to India Gate',
      subtitle: 'Morning cycling tour through historic Delhi',
      date: 'Mon, 16 Sep',
      time: '5:30 AM',
      ...
      checkpoints: [
        { name: 'Connaught Place', distance: 'Start', time: '5:30 AM', type: 'start' },
        { name: 'Rajpath', distance: '~ 5 km', time: '', type: 'checkpoint' },
        { name: 'India Gate Circle', distance: '~ 10 km', time: '', type: 'checkpoint' },
        { name: 'Lodhi Garden', distance: '~ 15 km', time: 'Finish', type: 'finish' },
      ],
      joinedFriends: [
        { name: 'Vikram', status: 'is joining', message: 'Ready to ride!' },
      ],
      sponsor: 'SUPERVOU',
      sponsorTagline: 'Better Humans\nA Healthier Tomorrow',
    },
    {
      ...
      subtitle: 'High-intensity interval training bootcamp',
      date: 'Tue, 17 Sep',
      time: '7:00 AM',
      ...
      checkpoints: [
        { name: 'Nehru Stadium', distance: 'Location', time: '7:00 AM', type: 'start' },
      ],
      joinedFriends: [
        { name: 'Hariom', status: 'is joining', message: 'Let\'s crush it!' },
      ],
      sponsor: 'SUPERVOU',
      sponsorTagline: 'Better Humans\nA Healthier Tomorrow',
    },
    {
      ...
      subtitle: 'Endurance swim session',
      date: 'Wed, 18 Sep',
      time: '6:00 AM',
      ...
      checkpoints: [
        { name: 'Siri Fort Pool', distance: 'Location', time: '6:00 AM', type: 'start' },
      ],
      joinedFriends: [
        { name: 'Priya', status: 'is joining', message: 'Can\'t wait!' },
      ],
      sponsor: 'SUPERVOU',
      sponsorTagline: 'Better Humans\nA Healthier Tomorrow',
    },
    {
      id: 6,
      icon: '⛰️',
      title: 'Aravalli Hills Trek',
      subtitle: 'Morning trek with breakfast',
      date: 'Sat, 21 Sep',
      time: '5:00 AM',
      ...
      checkpoints: [
        { name: 'Park Entrance', distance: 'Start', time: '5:00 AM', type: 'start' },
        { name: 'Ridge Trail', distance: '~ 3 km', time: '', type: 'checkpoint' },
        { name: 'Summit View', distance: '~ 6 km', time: '', type: 'checkpoint' },
        { name: 'Base Camp', distance: '~ 8 km', time: 'Finish', type: 'finish' },
      ],
      joinedFriends: [
        { name: 'Sehaj', status: 'is joining', message: 'Adventure time!' },
        { name: 'Vikram', status: 'is joining', message: 'Count me in!' },
      ],
      sponsor: 'SUPERVOU',
      sponsorTagline: 'Better Humans\nA Healthier Tomorrow',
    },
